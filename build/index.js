...
const redirectToMoreExamples = () => window.confirm('Want to redirect to "Block Development Examples" repo?') // eslint-disable-line no-alert
...
function Edit({
  ...
  const onChangeContent = newContent => {
    /* eslint-disable */console.log(...oo_oo(`431962462_35_2_35_25_4`, newContent));
    setAttributes({
      text: newContent
    });
  };
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    options: [{
      ...
      label: "Note With Icon",
      value: "noteWithIcon"
    }, {
      label: "Explanation",
      value: "explanation"
    }, {
      label: "Dual Box Notice",
      value: "dualBoxNotice"
    }, {
      label: "Block Notice",
      value: "blockNotice"
...
function save({
  ...
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, attributes.displayType));
}
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/spider-dev-alert-box","version":"0.1.0","title":"Spider Dev Alert Box","category":"text","icon":"smiley","description":"Example block scaffolded with Create Block tool.","example":{},"supports":{"html":false},"textdomain":"spider-dev-alert-box","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js","attributes":{"headingText":{"type":"string","selector":"h2","source":"html","default":"Notice Message! Your message here"},"text":{"type":"string","selector":"p","source":"html","default":"Notice Message! Your message here"},"content":{"type":"string","source":"html","selector":"p"},"alignment":{"type":"string","default":"none"},"displayType":{"type":"string","default":"alertBox"}}}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkspider_dev_alert_box"] = globalThis["webpackChunkspider_dev_alert_box"] || [];
